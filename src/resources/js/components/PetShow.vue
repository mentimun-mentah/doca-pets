<template>
  <div class="container">
    <section class="mt-3 detail-data">
      <h1 class="entry-title h3">
        6 Jenis dan Harga Ikan Guppy serta Cara Merawatnya
      </h1>
      <div class="post-thumbnail header row mb-3">
        <img
          src="https://i0.wp.com/hewanpedia.com/wp-content/uploads/2021/03/Guppy-Green-Red-Dragon.jpg?resize=1080%2C608&#038;ssl=1"
      ...
      <h3>
        <span class="ez-toc-section" id="1_Ikan_Guppy_Green_Red_Dragon"></span
        >1. Ikan Guppy Green Red Dragon<span class="ez-toc-section-end"></span>
      </h3>
      <p>
        <img src="https://i0.wp.com/hewanpedia.com/wp-content/uploads/2021/03/Guppy-Green-Red-Dragon.jpg?resize=1080%2C608&#038;ssl=1" />
      </p>
      <p>
