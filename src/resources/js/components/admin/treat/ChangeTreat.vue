            ...
            <div class="card shadow">
              <div class="card-header">
                <div class="row align-items-center">
                  <div class="col">
                    <h3 class="mb-0">Informasi Cara Merawat</h3>
                  </div>
                  <!-- /col -->
                </div>
                <!--/ row -->
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input
                    type="text"
                    class="form-control"
                    placeholder="Cara merawat anjing golden"
                ...
                <button type="submit" class="btn btn-danger" @click="updateTreat">
                  Simpan
                </button>
              </div>
              <!--/card-body -->
...
export default {
  ...
  methods:{
    ...
    updateTreat(){
      ...
      formData.append("id",this.treat.id)
      ...
      axios.post('/admin/treat/update',formData,config).then(res => {
        location.reload();
      }).catch(err => {
  ...
  mounted(){
    this.update_data.judul = this.treat.judul;
    this.update_data.photo = this.treat.photo;
    this.update_data.deskripsi = this.treat.deskripsi;
  }
}
</script>
